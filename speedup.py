...
def downloadFile(url):
    ...
    nospaces = name.replace(' ','_')
    os.rename(name,nospaces)
    return nospaces
...
if __name__ == '__main__':
    ...
    parser.add_argument('--frame_margin', type=float, default=1, help="Amount of silent frames adjacent to sounded frames that are included to provide context.")
    parser.add_argument('--sample_rate', type=float, default=44100, help="sample rate of the input and output videos")
    parser.add_argument('--frame_rate', type=float, default=30, help="frame rate of the input and output videos. Optional but for best results enter yourself")
